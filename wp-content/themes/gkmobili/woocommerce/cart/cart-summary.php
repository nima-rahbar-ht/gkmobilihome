        ...
        <div class="cart-summary__items woocommerce-cart-form__contents">
            <?php foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) :
                ...
                if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)): ?>
                    <div class="htheme_cart-summary__row">

                        <!-- Delete product -->
                        <div class="htheme_cart-summary__cell cart-summary__cell--delete">
                        ...
                        <!-- Product item -->
                        <div class="htheme_cart-summary__cell htheme_cart_prod_info">
                        ...
                        <!-- Quantity -->
                        <div class="htheme_cart-summary__cell htheme_cart_prod_quantity">
                                        ...
                                        $product_quantity = woocommerce_quantity_input(array(
                                            ...
                                            'params' => array(
                                                ...
                                                'data-cart-summary-quantity' => htmlspecialchars(json_encode(array(
                                                    ...
                                                    'data' => array(
                                                        'action' => 'premmerce_change_cart_quantity',
                        ...
                        <!-- Price -->
                        <div class="htheme_cart_prod_total">
                            <div class="htheme_cart-summary__price">
                                <div class="htheme_cart-price">
                                    <div class="cart-price__main cart-price__main--small">
                                       <div class="mobile_only cart_total_mobile"> <?php _e("Total:","cart_translations"); ?></div>
                            ...
                            <div class="input-group input-group--coupon coupon">
                                ...
                                <div class="input-group-btn">
                                    <input id="coupon_code" type="submit"
                                           ...
                                           value="<?php esc_attr_e('Apply', 'saleszone'); ?>"/>
                                </div>
                    ...
                    <div class="cart-summary__total-value">
                        <div class="cart-price">
                            <div class="cart-price__main cart-price__main--lg">
                                <?php echo wp_kses(WC()->cart->get_cart_subtotal(), premmerce_get_allowed_html('price')); ?>
                            </div>
                        </div>
                    </div>
                </div>
