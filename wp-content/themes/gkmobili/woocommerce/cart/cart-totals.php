...
<div class="frame cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="frame__inner">
        <div class="cart-totals">
            ...
            <ul class="cart-totals__list cart_sideb_cnt">
                ...
                <?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
                    ...
                    <ul class="cart_shipping_method_ul">
                ...
                <?php if ( wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart ) :
                    ...
                    $estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()? sprintf( ' <small>' . __( '(estimated for %s)', 'saleszone' ) . '</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
                        : '';
