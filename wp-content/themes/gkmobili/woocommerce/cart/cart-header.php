...
if(premmerce_option('catalog-mode')){
    return;
}
...
<?php if(premmerce_option('header_layout') == 'layout_5') :?>
    <li class="pc-header-layout-5__toolbar-item"  data-cart-header-fragment>
        <div class="pc-header-layout-5__toolbar-icon pc-header-layout-5__toolbar-icon--cart">
            <?php premmerce_the_svg('cart-thin'); ?>
...
<?php elseif(premmerce_option('header_layout') == 'layout_4') :?>
           ...
           rel="nofollow">
            ...
            <span class="cart-button__btn-cell">
                <i class="cart-button__icon">
                    <?php premmerce_the_svg('cart-bag'); ?>
    ...
    <div class="cart-header" data-cart-header-fragment>
        ...
        <div class="cart-header__aside">
            <a class="cart-header__ico<?php if (WC()->cart->is_empty()): ?> cart-header__ico--empty <?php endif; ?>"
               ...
               rel="nofollow"
            >
				<img src="<?php /* echo get_stylesheet_directory_uri(); */ ?>/wp-content/uploads/2021/10/fa-shopping-bag.svg" width="27" height="27" alt="cart icon">
