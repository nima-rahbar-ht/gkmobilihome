...
$use_lazyload = premmerce_option('category-product-lazyload');
$use_spinner = $use_lazyload && premmerce_option('category-product-lazyload-spinner');
    ...
    <a class="product-photo__item"
        ...
        <img class="product-photo__img"
            ...
            <?php else : ?>
                ...
                srcset="<?php echo esc_attr(wp_get_attachment_image_url( $variation->get_image_id(), apply_filters('single_product_archive_thumbnail_size', 'shop_catalog') )); ?>"
                sizes="<?php echo esc_attr(wp_get_attachment_image_url( $variation->get_image_id(), apply_filters('single_product_archive_thumbnail_size', 'shop_catalog') )); ?>"
            <?php endif; ?>

             data-product-medium-photo
             data-src-placeholder="<?php echo esc_url(wc_placeholder_img_src()); ?>"
             alt="<?php echo esc_attr(premmerce_get_img_alt($variation->get_image_id(), $variation->get_name())); ?>"
