...
?>
<div class="form form--bg woocommerce-billing-fields checkout-frame checkout-frame--billing">

    <div class="form__field">
        <h3 class="form__title form__title--border checkout_order_title_billing_order">
			<span>
