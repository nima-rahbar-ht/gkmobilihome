...
<div class="checkout_order_header">
    <div class="checkout_order_header_inner">
        <div class="corh_product"><?php _e("Product","checkout_translations"); ?></div>
        <div class="corh_quantity"><?php _e("Quantity","checkout_translations"); ?></div>
        <div class="corh_price"><?php _e("Total","checkout_translations"); ?></div>
    </div>
</div>
    <!-- Products -->
