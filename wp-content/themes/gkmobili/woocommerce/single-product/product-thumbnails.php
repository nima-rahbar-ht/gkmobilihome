...
$slides_attr = premmerce_option('product-thumbnails-type') == 'slides' ? 'data-slider-slide':'';
if (!$attachment_ids) {
    return;
}
?>
...
<?php if ($attachment_ids && $product->get_image_id()): ?>
    ...
    <li class="product-photo__thumb" <?php echo esc_attr($slides_attr); ?>>
        <a class="product-photo__thumb-item"
           ...
           data-product-photo-thumb="<?php echo esc_attr(wp_get_attachment_image_url($variation->get_image_id(), 'full')); ?>"
           data-product-photo-thumb-active
           data-magnific-galley-thumb
           data-magnific-galley-title="<?php echo esc_attr($variation->get_name()); ?>"
        >
            <img class="product-photo__thumb-img"
                 src="<?php echo esc_attr(wp_get_attachment_image_url($variation->get_image_id(), 'full')); ?>"
    ...
    <li class="product-photo__thumb" <?php echo esc_attr($slides_attr); ?>>
        ...
        >
            <img class="product-photo__thumb-img"
                 ...
                 alt="<?php echo esc_attr(premmerce_get_img_alt($product->get_image_id(), $product->get_name()) . ' ' . $attachment_id); ?>"
